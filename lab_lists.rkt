...
;; 1 PTS
(define (name first last) (list first last))
...
;; 1 PTS
(define (last-name name) (cadr name))
...
;; 2 PTS
(define (yoda words) (list (caddr words) (car words) (cadr words) ))
...
;; 3 PTS
(define (pig-latin word) (append (cdr word) (list(car word)) (list 'a 'y)))
...
;; 3 PTS
(define (quad-roots a b c)(list (/(- (- b (* 2 b)) (root a b c)) (* 2 a)) (/(+ (- b (* 2 b)) (root a b c)) (* 2 a))))
...
;; 2 PTS
(define (rotate c) (list c (rot1 c) (rot1 (rot1 c)) (rot1 (rot1 (rot1 c)))))
        
(define (rot1 c) (list (car(cdr c)) (- (car c) (* 2 (car c)))))
...
;; 1 PTS
(define (get-address s) (car(cddddr s)))
...
;; 1 PTS
(define (get-gpa s)(caddr(car(cdddr s))))
...
;; 2 PTS
(define (get-state s) (cadr(cadr(get-address s))))
...
;; 3 PTS
(define (combine-courses s1 s2)(append (caddr(cdddr s1)) (caddr(cdddr s2))))