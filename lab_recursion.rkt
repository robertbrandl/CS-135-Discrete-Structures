...
;; 1 PTS
(define (piecewise x) (if (> x 0) (+(* 2 (* x x)) 1) (+ x 1)))
...
;; 1 PTS
(define (sign x) (if (> x 0) '"positive" (if(= x 0) ' "zero" ' "negative")))
...
;; 3 PTS
(define (sum-pow p n) (if (= n 0) 0 (+ (expt n p) (sum-pow p (- n 1)) )))
...
;; 3 PTS
(define (subfact n)
  (cond ((= n 1) 0) ((= n 2) 1) ((and (> n 2)(= (remainder n 2) 0)) (+ 1(* n (subfact (- n 1))))) (else (- (* n (subfact (- n 1))) 1))))
...
(define (gen-fib a b n) (it a b n))

(define (it a b n) (if (= n 0) a (it b (+ a b) (- n 1))))
...
;; 2 PTS
(define (nth n L) (car (help n L)))

(define (help n L)  (if (= n 0) L (cdr (help (- n 1) L))))
...
;; 3 PTS
(define (product lst)(if (null? lst) 1 (* (car lst)(product (cdr lst)))))
...
;; 4 PTS
(define (filter P L) (if (null? L) (list) (if (P (car L)) (append (list (car L)) (filter P (cdr L))) (filter P (cdr L))) ))