...
;; 2 PTS
(define (xor p q)(or  (and p (not q)) (and q (not p))))
...
;; 3 PTS
(define (3majority p q r) (or (and p q) (and p r) (and q r)))
...
;; 3 PTS
(define (isosceles p q r) (and (3majority p q r) (or (not p) (not q) (not r))))