...
;; 5 PTS
(define (indegree E v) (if (null? E) 0 (if (equal? (cadar E) v) (+ 1 (indegree (cdr E) v)) (+  0 (indegree (cdr E) v)) )))
...
;; 5 PTS
(define (find-top G) (tHelp (get-vertices G) G))
(define (tHelp V G) (if (null? V) (topsort-error) (if (equal? 0 (indegree (get-edges G) (car V))) (car V) (tHelp (cdr V) G))) )
...
;; 5 PTS
(define (pop-vertex G v) (list (popv-vertices (get-vertices G) v) (popv-edges (get-edges G) v)))
...
;; 5 PTS
(define (topsort G) (reverse(topHelp G (list))))
(define (topHelp G L) (if (null? (get-vertices G) ) L (topHelp (pop-vertex G (find-top G)) (append (list(find-top G)) L))))